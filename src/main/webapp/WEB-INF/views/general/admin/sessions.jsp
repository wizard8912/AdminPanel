			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<table id="datatable"
						...
						<thead>
							<tr>
								<th><fmt:message key="admin.Sessions.Id" /></th>
								<th><fmt:message key="admin.Sessions.CreatedDate" /></th>
								<th><fmt:message key="admin.Sessions.DestroyedDate" /></th>
								<th><fmt:message key="admin.Sessions.IpAddress" /></th>
								<th><fmt:message key="admin.Sessions.SessionId" /></th>
								<th><fmt:message key="admin.Sessions.BrowserType" /></th>
								<th><fmt:message key="admin.Sessions.BrowserVersion" /></th>
								<th><fmt:message key="admin.Sessions.OS" /></th>
								<th><fmt:message key="admin.Sessions.User" /></th>
							</tr>
						</thead>
						<tfoot>
...
<script type="text/javascript">
	$(document).ready(function() {
		var dt = $('#datatable').DataTable({
			"ajax" : {
				"url" : '${ pageContext.request.contextPath }/admin/data/session',
				"dataSrc" : "data"
			},
			"columns" : [{
				"data" : "id"
