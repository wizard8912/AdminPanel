	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>
						<fmt:message key="admin.EmailTasks.Title" />
						<small><fmt:message key="admin.EmailTasks.Subtitle" /></small>
					</h2>
				...
				<div class="x_content">
					...
					<table id="datatable"
						...
						<thead>
							<tr>
								<th></th>
								<th><fmt:message key="admin.EmailTasks.Id" /></th>
								<th><fmt:message key="admin.EmailTasks.StartDate" /></th>
								<th><fmt:message key="admin.EmailTasks.EndDate" /></th>
								<th><fmt:message key="admin.EmailTasks.EmailsCount" /></th>
							</tr>
						</thead>
						<tfoot>
...
<script type="text/javascript">
	$(document).ready(function() {
		var dt = $('#datatable').DataTable({
			"ajax" : {
				"url" : '${ pageContext.request.contextPath }/admin/data/emailTask',
				"dataSrc" : "data"
			},
			"columns" : [{
