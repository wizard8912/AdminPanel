	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>
						<fmt:message key="admin.Logs.Title" />
						<small><fmt:message key="admin.Logs.Subtitle" /></small>
					</h2>
				...
				<div class="x_content">
					...
					<table id="datatable"
						...
						<thead>
							<tr>
								<th><fmt:message key="admin.Logs.Id" /></th>
								<th><fmt:message key="admin.Logs.Username" /></th>
								<th><fmt:message key="admin.Logs.Date" /></th>
								<th><fmt:message key="admin.Logs.Type" /></th>
								<th><fmt:message key="admin.Logs.IpAddress" /></th>
							</tr>
						</thead>
						<tfoot>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#datatable').DataTable({
			"ajax" : {
				"url" : '${ pageContext.request.contextPath }/admin/data/log',
				"dataSrc" : "data"
			},
			"columns" : [{
				"data" : "id"
