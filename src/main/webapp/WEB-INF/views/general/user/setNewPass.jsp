	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>
						<fmt:message key="form.RemindPass2.Title" />
						<small><fmt:message key="form.RemindPass2.Subtitle" /></small>
					</h2>
				...
				<div class="x_content">
					...
					<sf:form class="form-horizontal form-label-left"
						...
						<sf:input type="hidden" path="remindPassCode" />
						<div class="ln_solid"></div>
						<div class="form-group">
							<div class="col-md-6 col-md-offset-3">
								<button id="send" type="submit" class="btn btn-success">
									<fmt:message key="form.RemindPass2.Submit" />
								</button>
							</div>
						</div>
					</sf:form>
