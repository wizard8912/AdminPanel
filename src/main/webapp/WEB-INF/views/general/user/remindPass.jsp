	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>
						<fmt:message key="form.RemindPass.Title" />
						<small><fmt:message key="form.RemindPass.Subtitle" /></small>
					</h2>
				...
				<div class="x_content">
					...
					<sf:form class="form-horizontal form-label-left"
						action="./remindPassword" method="post"
						commandName="remindPassDto">
						...
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
								for="email"><fmt:message key="form.RemindPass.Email" />
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-3">
								<button id="send" type="submit" class="btn btn-success">
									<fmt:message key="form.RemindPass.Submit" />
								</button>
							</div>
						</div>
					</sf:form>
